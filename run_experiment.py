...
from fit_data import parse_fits
import chi
from sampling_model import create_E_function
from util import get_cosmology, read_truth_values
...
parser.add_argument('config', help='Path to experiments configuration file')
parser.add_argument(
    'results_path',
